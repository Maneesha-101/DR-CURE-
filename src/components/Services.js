  ...
  return (
    <section id="services" className="services">
      ...
      <div className="container">
        ...
        <p className="services-intro">
          Comprehensive healthcare services with expert care
        </p>
        ...
        {selectedService && (
          <div id="service-info" className="service-info">
            ...
            <p>
              {selectedService.name} services at Dr Cure Surgeries use advanced
              technology and expert doctors for safe treatment and faster recovery.
            </p>
